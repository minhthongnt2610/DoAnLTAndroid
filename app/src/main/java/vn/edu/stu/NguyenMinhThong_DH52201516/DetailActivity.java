...
public class DetailActivity extends AppCompatActivity {
    ...
    private void loadImage(byte[] imgBlob) {
        if (imgBlob == null) {
    ...
    private void checkEdit() {
        ...
        if (intent.hasExtra("id")) {
            ...
            edtId.setText(String.format("SP%03d", product.getId()));
    ...
    private void loadCategorySpinner() {
        ...
        ArrayAdapter<String> adapter =
                new ArrayAdapter<>(this, android.R.layout.simple_spinner_item, categoryNameLists);
    ...
    private void saveProduct() {
        ...
        if (isEdit) {
            ...
            Product p = new Product(0, name, categoryId, price, desc, imageBytes);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == REQUEST_CODE_IMAGE && resultCode == RESULT_OK && data != null) {
            ...
            try {
                ...
                imageBytes = stream.toByteArray();  // <-- LƯU BLOB
